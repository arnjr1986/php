...
<head>
 ...
 <script src="https://use.fontawesome.com/2801f8ef50.js"></script> 
...
<div class="w3-padding w3-content w3-text-grey w3-third w3-display-middle">
 ...
 $bd = "pwii";
    ...
    try{
    $sql = $conecta->prepare("DELETE FROM amigo WHERE idamigo = ?;");
    ...
    echo '
    <a href="listar.php">
    <h1 class="w3-button w3-indigo">Excluido com sucesso! </h1>
    </a>
    ';
    }catch(PDOException $e){
    echo '
