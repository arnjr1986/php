...
<body> 
<div> 
<h2 class="w3-container w3-teal w3-center ">Data de Hoje: 
    <?php 
    echo date("d/m/Y");
    ?>
</h2> 
...
<h2 class="w3-container w3-teal ">Escolha qual tabuada você deseja Visualizar</h2> 
    <form class="w3-container" method="post" action="formAction.php"> 
        ...
        <button class="w3-btn w3-blue-grey w3-margin w3-jumbo" name="btn9">9</button> <br> 
        ...
        <button class="w3-btn w3-blue-grey w3-margin w3-jumbo" name="btn6">6</button> <br> 
        ...
        <button class="w3-btn w3-blue-grey w3-margin w3-jumbo" name="btn3">3</button> <br> 
...
<h2 class="w3-container w3-teal ">Digite qualquer valor para gerar sua tabuada</h2> 
    ...
    <input class="w3-input w3-border w3-light-grey" name="txtValor" type="number" placeholder="Digite ex: 6"> <br> 
...
<h2 class="w3-container w3-teal ">Clique para Gerar todas as Tabuadas do 0 a 10</h2> 
    <form class="w3-container" method="post" action="formAction.php"> <br> 
